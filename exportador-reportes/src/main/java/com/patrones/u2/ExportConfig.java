 ...
 * Builder concentra la construcción y la validación.
 */
public class ExportConfig {
    ...
    public static class Builder {
        ...
        public Builder pageSize(String size) {
            this.pageSize = size;
            return this;
        }

        public Builder orientation(String o) {
            this.orientation = o;
            return this;
        }

        public Builder locale(String l) {
            this.locale = l;
            return this;
        }

        public Builder watermarkText(String text) {
            this.watermarkText = text;
            return this;
        }

        public Builder includeLogo(boolean include) {
            this.includeLogo = include;
            return this;
        }

        public Builder compress(boolean c) {
            this.compress = c;
            return this;
        }

        public Builder maxRowsPerPage(int max) {
        ...
        public ExportConfig build() {
            if (compress && (outputPath == null || outputPath.isBlank())) {
                throw new IllegalStateException(
                        "compress=true requiere especificar outputPath: "
                                + "no se puede comprimir un resultado en memoria");
            }
